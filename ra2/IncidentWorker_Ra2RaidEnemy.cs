...
namespace ra2
{
    public  static class IncidentWorker_Ra2RaidEnemy
    {
        ...
        private static Pawn spawnSpecialPawn(IncidentParms parms,String pawndef) {
                PawnGenerationRequest request = new PawnGenerationRequest(DefDatabase<PawnKindDef>.GetNamed(pawndef, true), parms.faction, PawnGenerationContext.NonPlayer, -1, false, false, false, false, true, true, 1f, false, true, true, false, false, false, false, null, null, null, null, null, null, null);
